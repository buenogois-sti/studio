  ...
  return (
    <SheetFooter className="border-none pt-0 bg-transparent">
      <div className="flex justify-between sm:w-full w-full gap-3 px-4 py-10">
        ...
        <div className="flex items-center gap-2 flex-1 justify-center text-xs text-muted-foreground">
        ...
        {!isLastStep ? (
          <Button 
            type="button" 
            onClick={onNext} 
            className="gap-2 min-w-[120px] bg-primary hover:bg-primary/90 transition-all"
          ...
          <Button 
            ...
            className="gap-2 min-w-[140px] bg-emerald-600 hover:bg-emerald-700 transition-all disabled:opacity-50"
            onClick={onSubmit}
          >
